...
from openstack_dashboard.dashboards.identity.vo_admin \
    import workflows as role_workflows

INDEX_URL = "horizon:identity:vo_admin:index"

class IndexView(tables.DataTableView):
    # A very simple class-based view...
    # Ioram 31/10/2014
    table_class = RoleTable
    template_name = 'identity/vo_admin/index.html'

    #print "Ioram IndexView" 
...
class CreateView(workflows.WorkflowView):
    ...
    template_name = 'identity/vo_admin/create.html'
...
class ManageView(tables.DataTableView):
    ...
    template_name = 'identity/vo_admin/manage.html'

    #print "Ioram ManageView" 
...
class BlacklistView(tables.DataTableView):
    ...
    template_name = 'identity/vo_admin/manage/blacklist.html'
...
class ChangeRoleView(workflows.WorkflowView):
    ...
    template_name = 'identity/vo_admin/user_membership.html'
...
class AddUserView(workflows.WorkflowView):
    ...
    template_name = 'identity/vo_admin/user_workflow.html'
